...
const Dashboard = () => {
  ...
  //it well show if completed or filled it will do ++.
  const fetchAllResume = async () => {
    try {
      setLoading(true);
      const response = await axiosInstance(API_PATHS.RESUME.GET_ALL);
      ...
      console.error("Error feteching resumes :", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDeleteResume = async () => {
    ...
    try {
      ...
      setResumeToDelete(null); // ✅ correct
      setShowDeleteConfirm(false); // ✅ correct
    }
  };
   ...
   <DashboardLayout>
    <div className={styles.container}>
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              <span className={styles.createButtonContent}>
                Create Now
                <LucideFilePlus
                  className="group-hover:translated-x-1 transition-transform"
                  size={18}
                />
              </span>
            </button>
          ...
          <div className={styles.grid}>
            ...
            {allResumes.map((resume) => (
              ...
              <ResumeSummaryCard
                ...
                isNew={moment().diff(moment(resume.createdAt), "days") < 7} // ✅ fixed typo
              />
            ))}
          </div>
        )}
          ...
          <div className="p-6">
            ...
            <CreateResumeForm
              onSuccess={() => {
                ...
                fetchAllResume(); // ✅ fixed function name
              }}
            />
          </div>
        </Modal>
        ...
        <Modal
          ...
          onClose={() => setShowDeleteConfirm(false)} // ✅ wrap in function
          title="Confirm Deletion"
          showActionBtn
          actionBtnText="Delete"
          actionBtnClassName="bg-red-600 hover:bg-red-700"
          onActionClick={handleDeleteResume} // ✅ correct delete handler
        >
          <div className="p-4">
