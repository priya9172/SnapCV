...
//UPDATED AT
  ...
  return (
    <div
      ...
      onClick={onSelect}
      onMouseEnter={() => setIsHovered(true)}  //MOuser or Swipe for mobile
...
export const TemplateCard=({thumbnailImg,isSelected,onSelect})=>{
  return(
    <div className={`group h-auto md:h-[300px] lg:h-[320] flex flex-col bg-white border-2 overflow-hidden
    ...
    ${isSelected ?'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50':'border-gray-200 hover:border-violet-300'}`}onClick={onSelect}>
      {thumbnailImg ?(
        <div className="relative w-full h-full overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-white/2 via-transparent
          ...
          {/*Hover Effect */}
          <div className="absolute insert-0 bg-gradient-to-t from-violet-100/30 to-transparent opacity-0
        ...
        <div className="w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-bar from-violet-50
        via-to-violet-600  to-fuchsia-50">
          <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to-fuchisia-500 rounded-2xl flex
