...
const StepProgress = ({progress}) => {
  return (
   ...
   <div className='relative w-full h-4 bg-white/5 backdrop-blur overflow-hidden rounded-full
   border border-white/10'>
    <div className='absolute inset-0 bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 animate-pulse'/>
    <div className='relative h-full bg-gradient-to-r from-violet-500 via-funchsia-500 to-violet-600
