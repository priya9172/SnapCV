...
// etching the resume details using backend URL
...
const fetchResumeDetailsById = async () => {
  try {
    ...
    if (response.data && response.data.profileInfo) {
      ...
      toast.error("Resume data missing or malformed")
    }
  } catch (error) {
...
//it well help in chooosing the preview as well as help in dowloding resume
  ...
  //this function well help in updating the resume.and puy will help in updation on backend
  ...
  //Dlete Function to delete any resume
  ...
  const downloadPDF = async () => {
    ...
    try {
      await html2pdf()
        ...
        .from(element)
        .save();//save the resume here we download it
  ...
  return (
    <DashboardLayout>
            ...
            <div className={containerStyles.grid}>
                <div className={containerStyles.formContainer}>
                    ...
                    <div className="p-4 sm:p-6">
                        ...
                        <div className='flex flex-wrap item-center justify-end gap-3'>
                    ...
                    <div className={containerStyles.previewContainer}>
                        ...
                        <div className='preview-container relative' ref={previewContainerRef}>
                            <div className={containerStyles.previewInner}>
                                ...
                                templetedId={resumeData?.template?.theme || ""}
       ...
       <Modal isOpen={openPreviewModal} onClose={()=>setOpenPreviewModal(false)}
        ...
        showActionBtn={isDownloading ? "Generating..." 
